...
public class PreguntaController {
    ...
    @PostMapping("/guardar")
    public String crear(@Valid @ModelAttribute Pregunta pregunta, BindingResult result, Model model, RedirectAttributes redirect) {
        if (result.hasErrors()) {
            model.addAttribute("tematicas", tematicaService.listarTodas());
            return "pregunta/form";
        }
    ...
    public String actualizar(@PathVariable Long id, @Valid @ModelAttribute Pregunta pregunta, BindingResult result, Model model, RedirectAttributes redirect) {
        if (result.hasErrors()) {
            model.addAttribute("tematicas", tematicaService.listarTodas());
            return "pregunta/form";
        }
